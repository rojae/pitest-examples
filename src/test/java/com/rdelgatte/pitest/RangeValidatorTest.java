...
class RangeValidatorTest {
  ...
  @Test
  @DisplayName("Sum Two Numbers Given 0, 0 ")
  void zero_zero_sum_Test()  { assertThat(cut.sum(1,10 )).isEqualTo(11); }

  @Test
  @DisplayName("Sum Two Numbers Given 1, 0")
  void one_zero_sum_Test()  { assertThat(cut.sum(1,1 )).isEqualTo(2); }
}
